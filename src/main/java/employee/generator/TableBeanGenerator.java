...
public class TableBeanGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		for (Table table : tableMap.values()) {
			...
			Reader reader = new FileReader("./src/main/java/employee/bean/bean.txt");
			...
			FileWriter writer = new FileWriter("./src/main/java/employee/bean/" + table.className + "Bean.java");
