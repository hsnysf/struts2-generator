...
public class TableEntityGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		for (Table table : tableMap.values()) {
			...
			Reader reader = new FileReader("./src/main/java/employee/entity/entity.txt");
			...
			FileWriter writer = new FileWriter("./src/main/java/employee/entity/" + table.className + ".java");
